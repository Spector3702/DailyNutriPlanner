    ...
    fetch(Url, {
        ...
        .then(responseData => {
            ...
            rowElement.innerHTML = `
                    ...
                    <tr>
                        <td>${responseData[0].analysis_item}</td>
                        <td>${responseData[1].analysis_item}</td>
                        <td>${responseData[2].analysis_item}</td>
                        <td>${responseData[3].analysis_item}</td>
                        <td>${responseData[4].analysis_item}</td>
                        <td>${responseData[5].analysis_item}</td>
                        <td>${responseData[6].analysis_item}</td>
                    </tr>
                    <br>
                    <tr>
                    ...
                    <table>
                    <colgroup span="6" style="background-color: #BAA0F2;"></colgroup>
                    <tr>
                        <td>${responseData[7].analysis_item}</td>
                        <td>${responseData[8].analysis_item}</td>
                        <td>${responseData[9].analysis_item}</td>
                        <td>${responseData[10].analysis_item}</td>
                        <td>${responseData[11].analysis_item}</td>
                        <td>${responseData[12].analysis_item}</td>
                    </tr>
                    <tr>
                    ...
                    <table>
                    <colgroup span="5" style="background-color: #BAA0F2;"></colgroup>
                    <tr>
                        <td>${responseData[13].analysis_item}</td>
                        <td>${responseData[14].analysis_item}</td>
                        <td>${responseData[15].analysis_item}</td>
                        <td>${responseData[16].analysis_item}</td>
                        <td>${responseData[17].analysis_item}</td>
                    </tr>
                    <tr>
